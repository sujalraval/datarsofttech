  ...
  const academicValues = [
    {
      ...
      description:
        "Motivates faculty and students to actively publish scholarly work",
      icon: BookOpen,
    },
    {
  ...
  const managementFeatures = [
    {
      ...
      features: [
        "Authors, reviewers, editors, readers",
    ...
    },
    {
      ...
      features: [
        "Reviewer database with expertise mapping",
    ...
    },
    {
      ...
      features: [
        ...
        "Peer review assignment & monitoring",
        "Editorial decisions and issue publishing",
      ],
    },
    {
      category: "Analytics & Security",
      features: [
        "Article views, downloads, citation insights",
        "Secure data handling and regular backups",
      ],
    },
  ];
        ...
        >
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="text-slate-900">
              ...
              >
                <span className="text-[#0494e2]">Research Journal</span> for
                Universities
              </h1>
              ...
              >
                A Research Journal is an official academic platform that enables
                universities and departments to publish, manage, and showcase
              ...
              >
                It plays a critical role in strengthening academic credibility,
                research output, and institutional rankings.
              </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {academicValues.map((value, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="p-6 border-slate-200 hover:border-[#0494e2]/30 transition-colors group text-center"
                >
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-100 border border-slate-200 mb-6">
                ...
                <span
                  className={`${TYPOGRAPHY.caption.sm} font-semibold text-slate-600 uppercase tracking-wider`}
                >
                  External Impact
                </span>
              </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              className={`${TYPOGRAPHY.body.lg} text-slate-600 max-w-2xl mx-auto`}
            >
              A departmental journal directly contributes to institutional
              excellence metrics
            </p>
          </div>
        ...
        >
          <div className="max-w-4xl mx-auto text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 mb-6">
              ...
              <span
                className={`${TYPOGRAPHY.caption.sm} font-semibold uppercase tracking-wider`}
              >
                Modern Platform
              </span>
            </div>
            ...
            <p
              className={`${TYPOGRAPHY.body.lg} text-slate-300 mb-8 leading-relaxed`}
            >
              A research journal today requires a robust, accessible, and
              scalable digital platform that supports publishing, discovery, and
              engagement.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              <h3 className={`${TYPOGRAPHY.heading.lg} font-bold mb-6`}>
              ...
              <div className="space-y-4">
                {keyCapabilities.map((capability, index) => (
                  <div
                    key={index}
                    className="flex items-start gap-3 p-4 bg-slate-800 rounded-lg"
                  >
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              className={`${TYPOGRAPHY.body.lg} text-slate-600 max-w-2xl mx-auto`}
            >
              Comprehensive tools for managing the entire research publication
              workflow
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {managementFeatures.map((feature, index) => (
              <Card
                key={index}
                className="p-6 border-slate-200 hover:shadow-lg transition-all"
              >
                <h3
                ...
                <ul className="space-y-2">
                  {feature.features.map((item, idx) => (
                    <li key={idx} className="flex items-start gap-2">
                      ...
                      <span className={`${TYPOGRAPHY.body.sm} text-slate-600`}>
                        {item}
                      </span>
                    </li>
                  ))}
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3
                      className={`${TYPOGRAPHY.heading.sm} text-slate-900 font-semibold`}
                    >
                      Article Insights
                    </h3>
                    <p className={`${TYPOGRAPHY.body.sm} text-slate-600`}>
                      Views, downloads, and citation tracking
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className={`${TYPOGRAPHY.body.sm} text-slate-600`}>
                      Secure handling and regular backups
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className={`${TYPOGRAPHY.body.sm} text-slate-600`}>
                      Future-ready platform for growth
                    </p>
                  </div>
                </div>
              </div>
              ...
              <Card className="p-8 bg-gradient-to-br from-slate-50 to-slate-100 border-2 border-slate-200">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-3 bg-white rounded-lg border border-slate-200">
                    <div className="text-2xl font-bold text-[#0494e2] mb-1">
                      15K+
                    </div>
      ...
      <section className="py-24 bg-gradient-to-r from-[#0494e2] to-cyan-600">
        ...
        >
          ...
          <div className="max-w-3xl mx-auto mb-10">
            <p
              className={`${TYPOGRAPHY.body.lg} text-blue-100 mb-8 leading-relaxed`}
            >
              Deep expertise in higher-education digital platforms. Proven
              experience in research, accreditation, and compliance systems.
              Secure, scalable, and institution-ready solutions.
            </p>

            <p className={`${TYPOGRAPHY.body.md} text-blue-100 mb-10`}>
              Datar Soft helps institutions build research ecosystems — not just
              websites.
            </p>
            ...
            <div className="text-blue-100">
              <span className={`${TYPOGRAPHY.body.md} font-medium`}>
                @datarsoft
              </span>
            </div>
          </div>
