  ...
  const keyImpacts = [
    {
      ...
      description:
        "Standardized process aligned with UGC and institutional guidelines",
      icon: ShieldCheck,
    },
    {
        ...
        >
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="text-slate-900">
              ...
              >
                <span className="text-[#0494e2]">Online Recruitment</span>{" "}
                System
              </h1>
              ...
              >
                ORS by Datarsoft digitizes faculty recruitment with a
                transparent, secure, and guideline-driven process.
              </p>

              <p
                className={`${TYPOGRAPHY.body.md} text-slate-600 mb-8 leading-relaxed`}
              >
                A fully online, role-based system ensuring faster hiring,
                accurate evaluation, and full UGC compliance.
              </p>
      ...
      <section className="py-24 bg-slate-50">
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ORS is designed to standardize and simplify academic recruitment
              by replacing manual workflows with a structured digital process
              aligned with UGC and institutional guidelines.
            </p>
            ...
            <Card className="p-8 bg-white border-2 border-[#0494e2]/20">
              <div className="text-center">
                ...
                <h3
                  className={`${TYPOGRAPHY.heading.lg} text-slate-900 font-bold mb-4`}
                >
                  Empowering Institutions
                </h3>
                <p
                  className={`${TYPOGRAPHY.body.md} text-slate-600 leading-relaxed max-w-2xl mx-auto`}
                >
                  ORS empowers institutions with a structured, transparent, and
                  policy-compliant recruitment framework that ensures fairness
                  and efficiency in academic hiring.
                </p>
              </div>
            </Card>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {userRoles.map((role, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="p-6 border-slate-200 hover:shadow-lg transition-all group"
                >
                  ...
                  <ul className="space-y-2">
                    {role.responsibilities.map((responsibility, idx) => (
                      <li key={idx} className="flex items-start gap-2">
                        ...
                        <span
                          className={`${TYPOGRAPHY.body.sm} text-slate-600`}
                        >
                          {responsibility}
                        </span>
                      </li>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {institutionalBenefits.map((benefit, index) => (
              <div
                key={index}
                className="flex items-start gap-3 p-4 bg-white rounded-lg border border-slate-200 hover:border-[#0494e2]/30 transition-colors"
              >
                    ...
                    <div className="ml-6 flex-1">
                      <Card className="bg-slate-800 border-slate-700 p-6">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <h3 className={`${TYPOGRAPHY.heading.md} font-bold`}>
                            {step.title}
                          </h3>
                        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p
                className={`${TYPOGRAPHY.body.lg} text-slate-600 mb-8 leading-relaxed`}
              >
                ORS is built on a secure, scalable, and accessible architecture
                that supports seamless recruitment workflows across devices
                while integrating smoothly with existing university systems.
              </p>
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p
              className={`${TYPOGRAPHY.body.lg} text-slate-600 mb-8 leading-relaxed`}
            >
              An automated API scoring system aligned with Institutional &
              Government (UGC) norms, enabling accurate, transparent, and
