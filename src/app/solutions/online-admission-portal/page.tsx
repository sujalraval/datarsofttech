  ...
  const features = [
    {
      ...
      description:
        "Manage leads and enquiries from first contact to final admission",
      icon: MessageCircle,
    },
    {
        ...
        >
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="text-slate-900">
              ...
              >
                <span className="text-[#0494e2]">Digital Admission Portal</span>{" "}
                & Smart CRM
              </h1>
              ...
              >
                Datar Soft&apos;s Online Admission Portal with integrated CRM
                brings the entire admission lifecycle—from first enquiry to
                final admission—onto one secure, structured digital platform.
              </p>
      ...
      <section className="py-24 bg-white">
        ...
        >
          <div className="text-center mb-16">
            ...
            >
              Admission Automation, Ease, Institutional Control, and
              NAAC-Aligned Records Management
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-6 border-slate-200 hover:border-[#0494e2]/30 transition-colors group">
              ...
              >
                Streamline the entire admission process with automated workflows
                that reduce manual tasks and improve efficiency.
              </p>
            </Card>
            ...
            <Card className="p-6 border-slate-200 hover:border-[#0494e2]/30 transition-colors group">
              ...
              <p
                className={`${TYPOGRAPHY.body.sm} text-slate-600 leading-relaxed`}
              >
                Maintain complete oversight and control over the admission
                process with role-based access and policy management.
              </p>
            </Card>
          </div>
        </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              className={`${TYPOGRAPHY.body.lg} text-slate-600 max-w-2xl mx-auto`}
            >
              Before an application is submitted, institutes must manage leads
              efficiently. The built-in CRM captures, tracks, and organizes all
              prospective student data—ensuring no enquiry is lost.
            </p>
          </div>
          ...
          <div className="mt-12 p-6 bg-white rounded-xl border border-slate-200">
            <h3
              className={`${TYPOGRAPHY.heading.md} text-slate-900 font-semibold mb-4`}
            >
              How It Works
            </h3>
            <p
            ...
            >
              Leads from websites, campaigns, consultants, and referrals are
              systematically recorded and nurtured through structured
              follow-ups, converting interest into quality applications. This
              structured approach improves response time, transparency, and
              conversion rates across departments.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p
                className={`${TYPOGRAPHY.body.lg} text-slate-600 mb-8 leading-relaxed`}
              >
                Once an enquiry is ready, it seamlessly moves into the formal
                admission process. Faculty and department teams can review
                applications through a centralized dashboard with complete
                student information already in place. Document verification,
                approvals, and remarks are handled digitally, reducing
                repetitive work and manual coordination.
              </p>
      ...
      <section className="py-24 bg-slate-900 text-white">
        ...
        >
          <div className="text-center mb-16">
            ...
            >
              For institutions, admissions data must be accurate, auditable, and
              inspection-ready. The system ensures all records—from leads to
              confirmed admissions—are securely stored and easily retrievable.
            </p>
          </div>
          ...
          <div className="mt-12 text-center">
            <p
              className={`${TYPOGRAPHY.body.lg} text-slate-300 max-w-3xl mx-auto`}
            >
              Role-based access, policy-driven seat allocation, and complete
              activity logs support governance and compliance while simplifying
              NAAC and audit preparation. One platform that manages leads,
              simplifies admissions, supports faculty, and strengthens
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              className={`${TYPOGRAPHY.body.lg} text-slate-600 max-w-2xl mx-auto`}
            >
              Everything you need to manage the entire admission lifecycle
              efficiently
            </p>
          </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              className={`${TYPOGRAPHY.body.lg} text-slate-600 max-w-2xl mx-auto`}
            >
              No scattered systems. No complex coordination. Digital Admission
              Portal handles your entire admission lifecycle through integrated
              modules.
            </p>
          </div>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p
              className={`${TYPOGRAPHY.body.lg} text-slate-600 max-w-2xl mx-auto`}
            >
              Experience the measurable benefits of our integrated admission
              management system
            </p>
          </div>
      ...
      <section className="py-24 bg-[#0494e2]">
        ...
        >
          <div className="text-center text-white">
            ...
            >
              Join institutions that have streamlined their admission processes
