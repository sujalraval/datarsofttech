...
export default function InstitutionalWebsiteCampusPortalPage() {
  const capabilities = [
    {
      ...
      description: "Centralized control for universities, campuses, colleges, and departments",
      icon: Building
    },
    {
    ...
    },
    {
      ...
      description: "Module-wise access control for different organizational units",
      icon: Layout
    }
  ];
  ...
  const websiteModules = [
    ...
    },
    {
      ...
      items: [
        "Extension services, publications & success stories"
      ]
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="text-slate-900">
              ...
              <h1 className={`${TYPOGRAPHY.display.xl} text-slate-900 font-bold mb-6 leading-tight`}>
                <span className="text-[#0494e2]">Institutional Website</span> & Campus Portal
              </h1>
              ...
              <p className={`${TYPOGRAPHY.body.md} text-slate-600 mb-8 leading-relaxed`}>
                A centralized, secure, and scalable digital platform designed for universities, multi-campus institutions, and affiliated colleges.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className={`${TYPOGRAPHY.body.md} text-slate-700`}>API-based integration with 45 Smart ERP modules</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className={`${TYPOGRAPHY.body.md} text-slate-700`}>Live academic, administrative & user data</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className={`${TYPOGRAPHY.body.md} text-slate-700`}>One unified digital ecosystem</span>
                </li>
              </ul>
            </div>
                ...
                <div className="space-y-4">
                  <div className="p-3 bg-slate-50 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className={`${TYPOGRAPHY.body.sm} font-medium text-slate-800`}>ERP System</span>
                    </div>
                    <div className="text-xs text-slate-600">Connected: Real-time data sync</div>
                  </div>
                  <div className="p-3 bg-slate-50 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="w-3 h-3 rounded-full bg-blue-500"></div>
                      <span className={`${TYPOGRAPHY.body.sm} font-medium text-slate-800`}>SIS Integration</span>
                    </div>
                    <div className="text-xs text-slate-600">Active: Student information sync</div>
                  </div>
                  <div className="p-3 bg-slate-50 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="w-3 h-3 rounded-full bg-purple-500"></div>
                      <span className={`${TYPOGRAPHY.body.sm} font-medium text-slate-800`}>LMS Platform</span>
                    </div>
                    <div className="text-xs text-slate-600">Integrated: Learning management</div>
                  </div>
                </div>
              </Card>
            </div>
      ...
      <section className="py-24 bg-gradient-to-br from-blue-50 via-white to-cyan-50">
        <div className={`${SECTION_SPACING.container.max} ${SECTION_SPACING.container.horizontal}`}>
          <div className="text-center mb-16">
            ...
            <p className={`${TYPOGRAPHY.body.lg} text-slate-600 max-w-2xl mx-auto`}>
              A dynamic and content-rich website representing the complete academic and institutional ecosystem.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {websiteModules.map((module, index) => (
              <Card key={index} className="p-6 border-slate-200 hover:shadow-md transition-shadow">
                ...
                <h3 className={`${TYPOGRAPHY.heading.sm} text-slate-900 font-semibold mb-3`}>
                  {module.category}
                </h3>
                ...
                <ul className="space-y-2">
                  {module.items.map((item, idx) => (
                    <li key={idx} className="flex items-start gap-2">
                      ...
                      <span className={`${TYPOGRAPHY.caption.sm} text-slate-600`}>{item}</span>
                    </li>
                  ))}
                </ul>
              </Card>
        ...
        <div className={`${SECTION_SPACING.container.max} ${SECTION_SPACING.container.horizontal}`}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-slate-800 border-slate-700 p-6">
              ...
              <h3 className={`${TYPOGRAPHY.heading.md} font-bold mb-3`}>Accessibility & Inclusivity</h3>
              <p className={`${TYPOGRAPHY.body.sm} text-slate-300`}>Built to meet Government of India Web Guidelines with focus on accessibility and inclusivity for all users.</p>
            </Card>
            ...
            <Card className="bg-slate-800 border-slate-700 p-6">
              ...
              <h3 className={`${TYPOGRAPHY.heading.md} font-bold mb-3`}>Security & Compliance</h3>
              <p className={`${TYPOGRAPHY.body.sm} text-slate-300`}>Robust security measures including VAPT testing, compliance audits, and multi-device compatibility.</p>
            </Card>
            ...
            <Card className="bg-slate-800 border-slate-700 p-6">
              ...
              <h3 className={`${TYPOGRAPHY.heading.md} font-bold mb-3`}>Performance & Usability</h3>
              <p className={`${TYPOGRAPHY.body.sm} text-slate-300`}>Optimized for performance and usability across all devices and user scenarios.</p>
            </Card>
          </div>

          <div className="mt-12">
            <h3 className={`${TYPOGRAPHY.heading.lg} font-bold mb-6 text-center`}>Compliance Features</h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
              {complianceFeatures.map((feature, index) => (
                <div key={index} className="flex items-center gap-3 p-3 bg-slate-800 rounded-lg">
                  <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0" />
                  <span className={`${TYPOGRAPHY.body.sm} text-slate-200`}>{feature}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className={`${SECTION_SPACING.container.max} ${SECTION_SPACING.container.horizontal}`}>
          <div className="text-center mb-16">
            ...
            <p className={`${TYPOGRAPHY.body.lg} text-slate-600 max-w-2xl mx-auto`}>
              Experience the measurable benefits of our integrated institutional management system
            </p>
          </div>
