    ...
    switch (action) {
      case "article-submission-demo":
        content = {
          ...
          description:
            "Submit your manuscript for peer review and publication.",
          form: [
            {
              label: "Article Title",
              type: "text",
            ...
            },
            {
              label: "Abstract",
              type: "textarea",
              placeholder: "Provide article abstract (250-300 words)",
            },
            {
              label: "Keywords",
              type: "text",
          ...
          reviews: [
            {
              ...
              status: "Completed",
              comments:
                "Well-structured research with significant contributions to the field.",
            ...
            },
            {
              ...
              status: "In Progress",
              comments:
                "Methodology is sound, but needs clarification on data sources.",
      ...
      case "editorial-dashboard-demo":
        content = {
          ...
          articles: [
            ...
            {
              id: "ART002",
              title: "Sustainable Campus Development Strategies",
      ...
      case "analytics-insights-demo":
        content = {
          ...
          metrics: [
            {
              metric: "Monthly Article Views",
              value: 15420,
              change: "+25%",
              icon: "👁️",
            },
            {
              metric: "Downloads This Month",
              value: 2340,
              change: "+18%",
              icon: "📥",
            },
            {
              metric: "Citation Growth",
              value: "32%",
              change: "+8%",
              icon: "📈",
            },
      ...
      case "journal-management-demo":
        content = {
          ...
          description:
            "Manage journal publications and institutional branding.",
          checklist: [
            {
              item: "Issue Planning and Scheduling",
              status: "Completed",
              completed: true,
            },
            {
      ...
      default:
        content = {
          ...
          description:
            "Your complete digital platform for academic research publishing, peer review, and scholarly communication with impact analytics and institutional branding.",
        };
    }
            ...
            <div className="space-y-2">
              {activeModule.id === "article-submission" && (
                <div className="text-center p-3 bg-white rounded-lg border border-slate-200">
                  ...
                  <div className="text-xs text-slate-600">
                    Easy manuscript upload and tracking
                  </div>
                </div>
              )}
              {activeModule.id === "peer-review" && (
                <div className="text-center p-3 bg-white rounded-lg border border-slate-200">
                  ...
                  <div className="text-xs text-slate-600">
                    Reviewer assignment and quality control
                  </div>
                </div>
              )}
              {activeModule.id === "editorial-dashboard" && (
                <div className="text-center p-3 bg-white rounded-lg border border-slate-200">
                  ...
                  <div className="text-xs text-slate-600">
                    Decision tracking and issue management
                  </div>
                </div>
              )}
              {activeModule.id === "analytics-insights" && (
                <div className="text-center p-3 bg-white rounded-lg border border-slate-200">
                  ...
                  <div className="text-xs text-slate-600">
                    Views, downloads, and citation metrics
                  </div>
                </div>
              )}
              {activeModule.id === "journal-management" && (
                <div className="text-center p-3 bg-white rounded-lg border border-slate-200">
                  ...
                  <div className="text-xs text-slate-600">
                    Issue planning and institutional branding
                  </div>
                </div>
              )}
                ...
                <div className="p-4 sm:p-6">
                  ...
                  {modalContent?.articles && (
                    <div className="overflow-x-auto">
                      <table className="w-full">
                        ...
                        <tbody>
                          {modalContent.articles.map(
                            (article: ArticleItem, index: number) => (
                              <tr
                                key={index}
                                ...
                                <td className="py-3">
                                  <div>
                                    ...
                                    <div className="text-xs text-slate-500">
                                      {article.author} • {article.department}
                                    </div>
                                  </div>
                                </td>
                                <td className="py-3">
                  ...
                  {modalContent?.metrics && (
                    <div className="grid grid-cols-2 gap-4">
                      {modalContent.metrics.map(
                        (metric: MetricItem, index: number) => (
                          <div
                            key={index}
                          ...
                          >
                            ...
                            <div className="text-xl font-bold text-[#0494e2] my-1">
                              {metric.value}
                            </div>
                  ...
                  {modalContent?.editorialTeam && (
                    <div className="space-y-4">
                      {modalContent.editorialTeam.map(
                        (member: EditorialMember, index: number) => (
                          <div
                            key={index}
