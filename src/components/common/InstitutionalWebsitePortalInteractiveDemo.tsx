...
const modules: ModuleData[] = [
  ...
  },
  {
    ...
    features: ['Profile Management', 'Research Tracking', 'Activity Monitoring'],
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: 'Accessibility Rating', value: 'AA+', trend: 'up', change: '+1' }
    ],
    ...
    switch(action) {
      case 'university-management-demo':
        content = {
          ...
          description: 'Centralized control panel for managing universities, campuses, colleges, and departments from a single system.',
          form: [
            { label: 'University Name', type: 'text', placeholder: 'Enter university name' },
            { label: 'Number of Campuses', type: 'number', placeholder: 'How many campuses?' },
            { label: 'Management Type', type: 'select', options: ['Centralized', 'Decentralized', 'Hybrid'] },
            { label: 'Integration Required', type: 'select', options: ['Yes', 'No'] }
          ]
        };
        break;
      case 'rbac-system-demo':
        content = {
          ...
          description: 'Secure and structured access management with granular permissions and audit trails.',
          checklist: [
      ...
      case 'website-modules-demo':
        content = {
          ...
          description: 'Dynamic and content-rich website modules representing the complete academic ecosystem.',
          stats: [
      ...
      case 'faculty-management-demo':
        content = {
          ...
          description: 'Comprehensive faculty profiles with research tracking and activity monitoring.',
          form: [
            { label: 'Faculty Name', type: 'text', placeholder: 'Enter faculty name' },
            { label: 'Department', type: 'text', placeholder: 'Enter department' },
            { label: 'Research Areas', type: 'textarea', placeholder: 'List research areas' },
            { label: 'Upload Profile Photo', type: 'file', placeholder: 'Select image file' }
          ]
        };
        break;
      case 'erp-integration-demo':
        content = {
          ...
          description: 'Real-time connectivity and data synchronization with Smart ERP modules.',
          events: [
            { name: 'Data Sync Status', date: 'Live', location: 'Connected', attendees: 45 },
            { name: 'API Health Check', date: 'Continuous', location: 'Monitoring', attendees: 0 },
            { name: 'Integration Reports', date: 'Daily', location: 'Dashboard', attendees: 0 }
          ]
        };
        break;
      case 'compliance-dashboard-demo':
        content = {
          ...
          description: 'GIGW 3.0 compliance monitoring and audit readiness tracking.',
          formats: [
            { name: 'GIGW Compliance', desc: 'Web guidelines adherence', icon: '📋' },
            { name: 'Accessibility Audit', desc: 'WCAG compliance', icon: '♿' },
            { name: 'Security Assessment', desc: 'VAPT testing', icon: '🔒' },
            { name: 'Performance Reports', desc: 'Load and usability', icon: '⚡' }
          ]
        };
        break;
      default:
        content = { 
          ...
          description: 'Your complete digital platform for managing universities, campuses, and affiliated colleges with integrated systems and compliance-ready features.' 
        };
    }
            ...
            <div className="space-y-2">
              {activeModule.id === 'university-management' && (
                <div className="text-center p-3 bg-white rounded-lg border border-slate-200">
                  <div className="font-medium text-slate-800 mb-1">Centralized University Control</div>
                  <div className="text-xs text-slate-600">Manage multiple campuses and departments</div>
                </div>
              )}
              {activeModule.id === 'rbac-system' && (
                <div className="text-center p-3 bg-white rounded-lg border border-slate-200">
                  <div className="font-medium text-slate-800 mb-1">Secure Access Management</div>
                  <div className="text-xs text-slate-600">Role-based permissions and audit trails</div>
                </div>
              )}
              {activeModule.id === 'website-modules' && (
                <div className="text-center p-3 bg-white rounded-lg border border-slate-200">
                  <div className="font-medium text-slate-800 mb-1">Dynamic Content Management</div>
                  <div className="text-xs text-slate-600">Rich website modules and SEO optimization</div>
                </div>
              )}
              {activeModule.id === 'faculty-management' && (
                <div className="text-center p-3 bg-white rounded-lg border border-slate-200">
                  <div className="font-medium text-slate-800 mb-1">Faculty Profile System</div>
                  <div className="text-xs text-slate-600">Research tracking and activity monitoring</div>
                </div>
              )}
              {activeModule.id === 'erp-integration' && (
                <div className="text-center p-3 bg-white rounded-lg border border-slate-200">
                  <div className="font-medium text-slate-800 mb-1">System Integration</div>
                  <div className="text-xs text-slate-600">Real-time data connectivity and sync</div>
                </div>
              )}
              {activeModule.id === 'compliance-dashboard' && (
                <div className="text-center p-3 bg-white rounded-lg border border-slate-200">
                  <div className="font-medium text-slate-800 mb-1">Compliance & Audit Ready</div>
                  <div className="text-xs text-slate-600">GIGW 3.0 and accessibility compliance</div>
                </div>
              )}
            </div>
