    ...
    switch (action) {
      case "applicant-portal-demo":
        content = {
          ...
          description:
            "Manage your academic job applications and profile information.",
          form: [
            {
              label: "Full Name",
              type: "text",
            ...
            },
            {
              ...
              type: "select",
              options: ["PhD", "Masters", "Bachelor", "Other"],
            },
            {
      ...
      case "api-scoring-demo":
        content = {
          ...
          stats: [
            ...
            {
              metric: "Teaching Experience",
              value: 8,
              trend: "Medium",
              icon: "🎓",
            },
            {
              metric: "Academic Qualifications",
              value: 95,
              trend: "High",
              icon: "🏆",
            },
            {
              metric: "Overall API Score",
              value: 87.5,
              trend: "High",
              icon: "📊",
            },
      ...
      case "admin-panel-demo":
        content = {
          ...
          description:
            "Manage recruitment system configuration and compliance.",
          checklist: [
            {
          ...
          formats: [
            {
              ...
              desc: "Application flow analysis",
              icon: "📊",
            },
            {
              name: "Candidate Performance",
              desc: "API score distribution",
              icon: "📈",
            },
            {
              name: "Time-to-Hire",
              desc: "Process efficiency metrics",
              icon: "⏱️",
            },
            {
              name: "Compliance Reports",
              desc: "UGC guideline adherence",
              icon: "📋",
            },
          ],
        };
      ...
      default:
        content = {
          ...
          description:
            "Your complete digital platform for academic faculty recruitment with UGC compliance and automated API scoring.",
        };
    }
            ...
            <div className="space-y-2">
              {activeModule.id === "applicant-portal" && (
                <div className="text-center p-3 bg-white rounded-lg border border-slate-200">
                  ...
                  <div className="text-xs text-slate-600">
                    Create profile, upload documents, track status
                  </div>
                </div>
              )}
              ...
              {activeModule.id === "api-scoring" && (
                <div className="text-center p-3 bg-white rounded-lg border border-slate-200">
                  ...
                  <div className="text-xs text-slate-600">
                    UGC-compliant API score calculation
                  </div>
                </div>
              )}
              {activeModule.id === "admin-panel" && (
                <div className="text-center p-3 bg-white rounded-lg border border-slate-200">
                  ...
                  <div className="text-xs text-slate-600">
                    User management, compliance monitoring
                  </div>
                </div>
              )}
              ...
              <div className="bg-white rounded-xl w-full max-w-md sm:max-w-2xl max-h-[90vh] overflow-y-auto">
                <div className="p-4 sm:p-6">
                  ...
                  {modalContent?.jobListings && (
                    <div className="space-y-4">
                      {modalContent.jobListings.map(
                        (job: JobListing, index: number) => (
                          <div
                            key={index}
                            className="p-4 border border-slate-200 rounded-lg hover:border-[#0494e2] transition-colors"
                          >
                            <div className="flex justify-between items-start mb-2">
                      ...
                      {modalContent.stats.map(
                        (stat: StatItem, index: number) => (
                          ...
                          >
                            ...
                            <div className="text-2xl font-bold text-[#0494e2] my-1">
                              {stat.value}
                            </div>
                            <div
